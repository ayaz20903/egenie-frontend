  ...
  return (
    <section className="w-full bg-white py-20 ">
      ...
      <div className="text-center mb-[100px]">
        <h3 className="text-3xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-[#6D28D9] to-[#3B82F6] bg-clip-text text-transparent WhatsAppMarketingHeading">
          Conversations with a touch of <span>MAGIC</span>
        </h3>
        <p className="text-2xl bg-gradient-to-r from-[#6D28D9] to-[#3B82F6] bg-clip-text text-transparent">
          Engage your audience, boost sales, and scale without lifting a finger.
        </p>
      </div>

      {/* Two-column layout */}
      <div className="grid grid-flow-row-dense grid-cols-7 gap-5 items-center">
        {/* Left Side */}
